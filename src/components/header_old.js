...
export default function Header({ className, showCurrentPageHighlight }) {
  ...
  const buttons = [
    {
      name: "Home",
      onClick: () => (showCurrentPageHighlight ? scrollTo("home") : gotoHome()),
    },
    {
      name: "About",
      onClick: () =>
        showCurrentPageHighlight ? scrollTo("about") : gotoHome(),
    },
    {
      name: "Services",
      onClick: () =>
        showCurrentPageHighlight ? scrollTo("services") : gotoHome(),
    },
    {
      name: "Case Studies",
      onClick: () =>
        showCurrentPageHighlight ? scrollTo("case-studies") : gotoHome(),
    },
    {
      name: "Team",
      onClick: () => (showCurrentPageHighlight ? scrollTo("team") : gotoHome()),
    },
    {
      name: "Blog",
      onClick: () => (showCurrentPageHighlight ? scrollTo("blog") : gotoHome()),
    },
  ];
