...
export default function SocialButton({ Icon, Name }) {
  return (
    <div className="bg-white/10 p-2 relative rounded-full border border-white/10 group cursor-pointer">
      ...
      <Icon className="group-hover:scale-110 z-10 transition-all duration-500" />
